				...
				<?php if ( $instance['teaser-thumb'] == on ) {
					...
					if ( has_post_thumbnail() ) {
						the_post_thumbnail( 'homethumb', array(
							'class' => 'catboxthumb',
							'style' =>
								'margin-bottom:10px; float:' . $thumbplacement . '; margin-'
								. $thumbplacement . ':0px;'
						) );
					} else if ( $feature_photo ) { ?><a href="<?php the_permalink(); ?>"><img
						...
						if ( $attachment ) { ?><a href="<?php the_permalink(); ?>"><img
...
<div <?php if ( $customcolors == on
			) { ?>style="background-color:<?php echo $instance['header-color']; ?> !important;"<?php } ?>class="widgetfooter<?php if ( $instance['widget-style']
			                                                                                                                           == "Style 3"
