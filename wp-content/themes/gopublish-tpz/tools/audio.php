...
class sno_audio extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( ( $instance['category'] == - 1 ) || ( $instance['number'] <= 0 ) ) {
			...
			<div class="widgetwrap">
				...
				while ( $recent->have_posts() ) : $recent->the_post();
					...
					<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>">
						<h3 class="homeheadline" style="font-size:<?php echo $headlinesize; ?>px; line-height:<?php echo $headlineheight; ?>px;"><?php the_title(); ?></h3>
					</a>
					...
					if ( $instance['teaser-thumb'] == 'on' ) {
						...
						if ( has_post_thumbnail() ) {
							...
							<a href="<?php the_permalink(); ?>">
								<img src="<?php echo $feature_photo; ?>" class="catboxthumb" style="float:<?php echo $thumbplacement; ?>;margin-bottom:10px;margin-<?php echo $thumbplacement; ?>:0px;width:70px" />
							</a>
						<?php } else {
							global $wpdb;
							...
							if ( $attachment ) { ?>
								<a href="<?php the_permalink(); ?>">
									<img src="<?php echo $attachment; ?>" class="catboxthumb" style="float:<?php echo $thumbplacement; ?>;margin-bottom:10px;margin-<?php echo $thumbplacement; ?>:0px;width:70px" />
								</a>
							<?php }
						}
					}
			...
			<div <?php
				...
				<?php } ?>
				class="widgetfooter<?php if ( $instance['widget-style'] == "Style 3" ) { ?>3<?php } else { ?>1<?php } ?>"></div>
			</div>
		<?php
		}
	}
	...
	function form( $instance ) {
		...
		<div style="float:left;width:230px;margin-right:20px;border-right:1px solid #aaaaaa;padding-right:10px;">
			...
			<?php $categorytitle = cat_id_to_name( $instance['category'] ); ?>
			<input type="hidden" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $categorytitle; ?>" />
			...
			<p>
				<input class="checkbox" type="checkbox" <?php if ( $instance['teaser-thumb'] == on ) {
					echo checked;
				} ?> id="<?php echo $this->get_field_id( 'teaser-thumb' ); ?>" name="<?php echo $this->get_field_name( 'teaser-thumb' ); ?>" />
			...
			<p>
				<input class="checkbox" type="checkbox" <?php if ( $instance['dividing-line'] == on ) {
					echo checked;
				} ?> id="<?php echo $this->get_field_id( 'dividing-line' ); ?>" name="<?php echo $this->get_field_name( 'dividing-line' ); ?>" />
				...
				<input class="checkbox" type="checkbox" <?php if ( $instance['view-all'] == on ) {
					echo checked;
				} ?> id="<?php echo $this->get_field_id( 'view-all' ); ?>" name="<?php echo $this->get_field_name( 'view-all' ); ?>" />
		...
		<div style="float:left;width:210px">
			...
			<p>
				<input class="checkbox" type="checkbox" <?php if ( $instance['custom-colors'] == on ) {
					echo checked;
				} ?> id="<?php echo $this->get_field_id( 'custom-colors' ); ?>" name="<?php echo $this->get_field_name( 'custom-colors' ); ?>" />
			...
			<p>
				<input class="colorwellaudio<?php echo $number; ?>" id="<?php echo $this->get_field_id( 'header-color' ); ?>" name="<?php echo $this->get_field_name( 'header-color' ); ?>" type="text" maxlength="7" size="7" value="<?php echo $instance['header-color']; ?>" /> Header Bar
				<br />
